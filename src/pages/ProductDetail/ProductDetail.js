        ...
        <div className="product-detail">
              ...
              {/* content */}
                    ...
                    <div className={styles.carouselSlide} >
                        ...
                        <div className={styles.carouselInner} >
                            ...
                            <div className={styles.carouselItem+' '+styles.active}> 
                                <img src={require("../../assets/images/big-img-01.jpg")} alt="first slide" />
                            </div>

                            <div className={styles.carouselItem}>
                                 <img src={require("../../assets/images/big-img-02.jpg")} alt="Second slide" />
                            </div>

                            <div className={styles.carouselItem}>
                                <img src={require("../../assets/images/big-img-03.jpg")} alt="Third slide"/> 
                            </div>
                        ...
                        <ol className={styles.carouselIndicators}>
                            <li data-target="#carousel-example-1" data-slide-to="0" className={styles.active}>
                            <img src={require("../../assets/images/smp-img-01.jpg")} alt="pic1"/>
                            </li>

                            <li data-target="#carousel-example-1" data-slide-to="1">
                            <img src={require("../../assets/images/smp-img-02.jpg")} alt="pic2"/>
                            </li>

                            <li data-target="#carousel-example-1" data-slide-to="2">
                            <img src={require("../../assets/images/smp-img-03.jpg")} alt="pic3"/>
                            </li>
                        </ol>
                    </div>
                </Col>
                ...
                <Col xl={14} lg={14} md={12}>
                    <div className={styles.productDetail}>
                        ...
                        <p ><span> More than 20 available /8 sold</span></p>
                        ...
                        <ul>
                            ...
                            <button className={styles.btnHover+' '+styles.color2}>Buy New</button>
                            <button className={styles.btnHover+' '+styles.color2}>Add to cart</button>
							</div>
            ...
            <Row style={{margin:'5rem 0'}}>
                <Col lg={24}>
                    ...
                    {/* product */}
                    <div style={{padding:'0px 0'}} className={styless.categoriesShop}>
